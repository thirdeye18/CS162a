...
/*********************************************************************
** This function provides validates that an even integer value is   
** stored for the string passed to it.  Returns true if the passed  
** value is even, or false if not. 
*********************************************************************/
...
/*********************************************************************
** Function to verify that a string contains useable data.  Ensures 
** that string is not just spaces, or enter. 
*********************************************************************/
