...
/*This adds options tot he menu from text file name supplied as
...
void Menu::addOption(string fileNameIn)
{
	...
	if (!menuFile)
	{
		cout << "Unable to find Menu text file\n";
	}
...
/*This function receives string input fromt he user, performs integer input 
  validation, then return the int choice converted from the string*/
